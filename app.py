...
ROUNDS = [
    {
        ...
        "company_news": {
            "Nova Teknoloji": {"summary": "Yeni fabrika açacak.", "detail": "Ancak bunun için çok borçlanacak.", "signal": "Olumlu ama riskli"},
            "Güven Bank": {"summary": "Geri ödenmeyen krediler biraz arttı.", "detail": "Ancak bankanın durumu hâlâ güçlü.", "signal": "Hafif olumsuz"},
            "Yeşil Enerji": {"summary": "Devletten destek aldı.", "detail": "Yeni projelerini daha ucuza yapabilir.", "signal": "Olumlu"},
            "Hızlı Havayolları": {"summary": "Yolcu sayısı değişmedi.", "detail": "Ancak yakıt daha pahalı oldu.", "signal": "Nötr"},
            "Bereket Gıda": {"summary": "Üretim giderleri arttı.", "detail": "Şirket ürün fiyatlarını yükseltebilir.", "signal": "Hafif olumsuz"},
            "SağlıkPlus": {"summary": "Yeni ürünü için izin bekliyor.", "detail": "İzin çıkarsa daha çok kazanabilir.", "signal": "Olumlu ama belirsiz"},
        },
    ...
    },
    {
        ...
        "company_news": {
            "Nova Teknoloji": {"summary": "Hisse son aylarda çok yükseldi.", "detail": "Sosyal medyada herkes bu hisseyi konuşuyor.", "signal": "Popüler ama pahalı"},
            "Güven Bank": {"summary": "Yeni müşteri sayısı arttı.", "detail": "Ancak bu artış hemen büyük kazanç sağlamayabilir.", "signal": "Hafif olumlu"},
            "Yeşil Enerji": {"summary": "Yeni proje için ilk izni aldı.", "detail": "Ancak parayı nasıl bulacağı henüz belli değil.", "signal": "Olumlu ama belirsiz"},
            "Hızlı Havayolları": {"summary": "Yurt dışı bilet satışları azaldı.", "detail": "Bu düşüş geçici olabilir.", "signal": "Hafif olumsuz"},
            "Bereket Gıda": {"summary": "Ürünlerini daha fazla mağazada satacak.", "detail": "Satışları zamanla artabilir.", "signal": "Olumlu"},
            "SağlıkPlus": {"summary": "Yeni bir klinik açacak.", "detail": "Önce para harcayacak, sonra daha çok hastaya hizmet verebilir.", "signal": "Dengeli"},
        },
    ...
    },
    {
        ...
        "company_news": {
            "Nova Teknoloji": {"summary": "Yeni siparişleri arttı.", "detail": "Ancak paranın tamamı henüz şirkete gelmedi.", "signal": "Hafif olumlu"},
            "Güven Bank": {"summary": "Banka para kazanmakta zorlanıyor.", "detail": "Müşterilere ödediği faiz arttı.", "signal": "Olumsuz"},
            "Yeşil Enerji": {"summary": "Kârı çok arttı.", "detail": "Ancak bu kazanç işlerinden değil, bir bina satışından geldi.", "signal": "Göründüğünden zayıf"},
            "Hızlı Havayolları": {"summary": "Kargodan daha çok kazandı.", "detail": "Bu gelir, azalan yolcu gelirini biraz karşıladı.", "signal": "Nötr"},
            "Bereket Gıda": {"summary": "Ürünlerinden daha çok kazanmaya başladı.", "detail": "Giderlerini iyi yönetti.", "signal": "Olumlu"},
            "SağlıkPlus": {"summary": "Bir defaya özel büyük bir ödeme yaptı.", "detail": "Bu yüzden kârı düştü, ancak işleri iyi gidiyor.", "signal": "Geçici olumsuz"},
        },
    ...
    },
    {
        ...
        "company_news": {
            "Nova Teknoloji": {"summary": "Bazı parçalar geç geldi.", "detail": "Şirket başka bir satıcı bularak sorunu çözmeye çalışıyor.", "signal": "Geçici olumsuz"},
            "Güven Bank": {"summary": "Banka olası zararlar için daha fazla para ayırdı.", "detail": "Şimdi daha az kazanabilir ama daha güvende olur.", "signal": "Temkinli olumlu"},
            "Yeşil Enerji": {"summary": "Bir projenin izni gecikti.", "detail": "Diğer projeler normal devam ediyor.", "signal": "Hafif olumsuz"},
            "Hızlı Havayolları": {"summary": "Yakıt çok pahalandı.", "detail": "Ancak şirket yakıtın çoğunu önceden daha düşük fiyattan almıştı.", "signal": "İlk haberden daha iyi"},
            "Bereket Gıda": {"summary": "Temel gıda ürünlerine talep arttı.", "detail": "İnsanlar bu ürünleri her durumda almaya devam ediyor.", "signal": "Olumlu"},
            "SağlıkPlus": {"summary": "Yeni kuralla bazı tedavilerin ücreti karşılanacak.", "detail": "Şirkete daha fazla hasta gelebilir.", "signal": "Olumlu"},
        },
    ...
    },
    {
        ...
        "company_news": {
            "Nova Teknoloji": {"summary": "Satış hedefi değişmedi.", "detail": "Ancak yüksek faiz şirketin borçlanmasını pahalılaştırabilir.", "signal": "Şirket iyi, piyasa zayıf"},
            "Güven Bank": {"summary": "Banka müşterilerine daha fazla faiz ödeyecek.", "detail": "Bu yüzden kazancı azalabilir.", "signal": "Olumsuz"},
            "Yeşil Enerji": {"summary": "Ürünlerini uzun süre aynı fiyattan satacak.", "detail": "Geliri daha belli ama yüksek faiz onu da etkileyebilir.", "signal": "Dengeli"},
            "Hızlı Havayolları": {"summary": "Şirketin borcu fazla.", "detail": "Faiz yükseldiği için borç ödemesi daha pahalı olabilir.", "signal": "Olumsuz"},
            "Bereket Gıda": {"summary": "İnsanlar gıda almaya devam ediyor.", "detail": "Şirketin borcu da az olduğu için daha az etkilenebilir.", "signal": "Görece dayanıklı"},
            "SağlıkPlus": {"summary": "Satışları ve kazancı arttı.", "detail": "Ancak piyasa düştüğü için hissesi yine de düşebilir.", "signal": "Şirket iyi, piyasa zayıf"},
        },
    ...
    },
    {
        ...
        "company_news": {
            "Nova Teknoloji": {"summary": "Yurt dışından büyük bir sipariş aldı.", "detail": "Haber şirket tarafından doğrulandı.", "signal": "Olumlu ve doğrulanmış"},
            "Güven Bank": {"summary": "Banka hakkında resmî inceleme başladı.", "detail": "Sonucun ne olacağı henüz belli değil.", "signal": "Belirsiz ve riskli"},
            "Yeşil Enerji": {"summary": "Yurt dışında yeni bir ortaklık kurdu.", "detail": "Haber resmî olarak açıklandı.", "signal": "Olumlu ve doğrulanmış"},
            "Hızlı Havayolları": {"summary": "Yeni uçuşlara ilgi arttı.", "detail": "Bilet satışlarındaki artış şirket tarafından doğrulandı.", "signal": "Olumlu"},
            "Bereket Gıda": {"summary": "Ürünlerinde sorun olduğu söylendi.", "detail": "Şirket bu haberin doğru olmadığını açıkladı.", "signal": "Söylenti doğrulanmadı"},
            "SağlıkPlus": {"summary": "Büyük bir sözleşme söylentisini yalanladı.", "detail": "Ancak yurt dışına hizmet satacağını resmen açıkladı.", "signal": "Söylenti yanlış, resmî haber olumlu"},
        },
